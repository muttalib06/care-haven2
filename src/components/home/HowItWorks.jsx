  ...
  const steps = [
    {
      ...
      description:
        "Tell us who needs care and where. We'll show you qualified caregivers in your area ready to help.",
      highlights: [
        "Child, elderly, or special care",
        "Search by location",
        "Quick & easy",
      ],
    },
    {
      ...
      description:
        "Browse verified profiles with real reviews. Every caregiver is background-checked for your safety.",
      highlights: [
    ...
    },
    {
      ...
      title: "Book & Schedule",
      description:
        "Pick your date and time with flexible scheduling. See clear pricing upfront—no surprises.",
      highlights: [
    ...
    },
    {
      ...
      description:
        "Relax knowing your loved one is in good hands. We're here to support you every step of the way.",
      highlights: [
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-12 md:mb-16">
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-gray-900 mb-4">
            How It <span style={{ color: "#3490c5" }}>Works </span>
          </h2>
          <p className="text-lg md:text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
            Getting the care you need is simple. Follow these four easy steps to
          ...
          {steps.map((step, index) => (
            <div key={index} className="relative">
              ...
              {index < steps.length - 1 && (
                <div
                  className="absolute top-16 left-1/2 w-full h-0.5 bg-gradient-to-r from-blue-300 to-blue-200 z-0"
            ...
            <div key={index} className="relative">
              ...
              <div className="relative flex gap-4">
                ...
                <div className="flex-1 bg-white rounded-xl shadow-lg p-6 border-l-4 border-blue-500">
                  {/* Step Number */}
                  <span className="text-5xl font-bold text-blue-100 block mb-2">
                    {step.number}
                  </span>
