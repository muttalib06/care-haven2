...
const SignUp = () => {
  ...
  return (
    <div className="min-h-screen mb-10 flex flex-col lg:flex-row bg-background">
      {/* Left Side - Form */}
      ...
      <div className="hidden lg:flex flex-1 relative bg-care-soft">
        ...
        <div className="absolute inset-0">
          ...
          <div className="absolute inset-0 bg-gradient-to-t from-[#3490c5]/90 via-[#3490c5]/50 to-transparent"></div>
        </div>
